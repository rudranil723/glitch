...
class _PageState extends State<Page> {
  final List<String> _arr =
      List.generate(9, (index) => index == 0 ? '' : index.toString());
  final List _images = [
    '',
    'assets/game/img1.png',
    'assets/game/img2.png',
    'assets/game/img3.png',
    'assets/game/img4.png',
    'assets/game/img5.png',
    'assets/game/img6.png',
    'assets/game/img7.png',
    'assets/game/img8.png',
  ];
  _change(int i) {
  ...
  void initState() {
    ...
    while (!flag) {
      ...
      for (i = 0; i < 8; i++)
        for (j = 0; j < i; j++) {
          var va1 = (_arr[j] == '') ? 0 : int.parse(_arr[j]),
              va2 = (_arr[i] == '') ? 0 : int.parse(_arr[i]);
          if (va1 > va2) cnt++;
        }
